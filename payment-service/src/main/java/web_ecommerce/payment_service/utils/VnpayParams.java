package web_ecommerce.payment_service.utils;
...
public class VnpayParams {
    ...
    public static final String vnp_BankCode = "vnp_BankCode";
    public static final String vnp_TxnRef = "vnp_TxnRef";
    public static final String vnp_TransactionNo = "vnp_TransactionNo";
